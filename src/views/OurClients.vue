      ...
      <div class="owl-carousel testimonial-carousel owl-loaded owl-drag">
        <div class="testimonial-item">
          <div class="d-flex align-items-center mb-3">
            <img class="img-fluid" src="@/assets/img/وسام-صنعت-دانش-فروز-1.png" alt="" />
            <div class="ml-3">
              <h4>Client Name</h4>
              <i>Profession</i>
            </div>
...
<style lang="css" scoped src="@/assets/css/owl.carousel.min.css"></style>
<!-- <style lang="scss" scoped src="@/assets/scss/style.coffee.scss"></style> -->