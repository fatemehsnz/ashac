    ...
    services: [
      ...
      },
      {
        ...
        items: [{
          ...
          desc: [
            { text: '● ایزو 9001 (سیستم مدیریت کیفیت)', link: 'link1' },
            { text: '● ایزو 13485 (سیستم مدیریت کیفیت تجهیزات پزشکی)', link: 'link2' },
            { text: '● گواهینامه IMS (سیستم مدیریت یکپارچه ims شامل سه استاندارد ایزو 9001، ایزو 14001 و ایزو 45001)', link: 'link3' },
            { text: '● ایزو 16949 (استاندارد مدیریت کیفیت تولید خودرو - IATF)', link: 'link4' },
            { text: '● مدل EFQM (بنیاد اروپایی برای مدیریت کیفیت)', link: 'link5' },
            { text: '● گواهینامه CE (استانداردهای تعیین‌شده اتحادیه اروپا)', link: 'link6' }
        ],
         style: 'padding_0 margin_right20'
        }
      ]
