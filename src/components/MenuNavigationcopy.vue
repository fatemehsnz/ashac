  ...
  <header>
    ...
    <div class="head-top">
      <div class="container-fluid">
        <div class="row">
          <div
            class="col-8 col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-5 col-xs-6"
          >
            <div class="logo">
              <a href="index.html">
          ...
          <div
            class="col-12 col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-5 col-xs-0"
          >
            <ul
              class="email dir-rtl"
            ...
            >
              <li>
                <a
                  href="mailto:ashagroup.c@gmail.com?subject=feedback"
          ...
          <div
            class="col-12 col-xxl-7 col-xl-6 col-lg-6 col-md-4 col-sm-2 col-xs-3"
          >
